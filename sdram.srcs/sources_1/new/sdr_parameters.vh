...
`elsif den128Mb
    ...
    `elsif x8
        ...
        parameter ROW_BITS         =      12; // Set this parameter to control how many Row bits are used
        parameter COL_BITS         =      10; // Set this parameter to control how many Column bits are used
        parameter DQ_BITS          =      32; // Set this parameter to control how many Data bits are used                   ////////////////////////////////////////////////////////////////             8
        parameter DM_BITS          =       1; // Set this parameter to control how many DM bits are used                    ////////////////////////////////////////////////////////////////             1
        parameter BA_BITS          =       2; // Bank bits
    `else `define x16
        parameter ADDR_BITS        =      12; // Set this parameter to control how many Address bits are used
        parameter ROW_BITS         =      12; // Set this parameter to control how many Row bits are used
