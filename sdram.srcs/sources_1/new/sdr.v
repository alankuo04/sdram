...
`endif             
    ...
    // Detect Read or Write command
            ...
            if (Data_in_enable == 1'b1) begin                                   // Writing Data to Memory
                // Array buffer
                //case (Bank)   
                //    2'b00 : Dq_dqm = bdq[0];// Bank0 [{Row, Col}];
                //    2'b01 : Dq_dqm = bdq[1];//Bank1 [{Row, Col}];
                //    2'b10 : Dq_dqm = bdq[2];//Bank2 [{Row, Col}];
                //    2'b11 : Dq_dqm = bdq[3];//Bank3 [{Row, Col}];
                //endcase
                
                //if(Dqm[0] == 1'b0) Dq_dqm[7:0] = Dqi [ 7: 0];//Dq
                //if(Dqm[1] == 1'b0) Dq_dqm[15:8] = Dqi [ 15:8];
                //if(Dqm[2] == 1'b0) Dq_dqm[23:16] = Dqi [ 23:16];
                //if(Dqm[3] == 1'b0) Dq_dqm[31:24] = Dqi [ 31:24];
...
// ---- Remove below, only handle read/write command, ignore others
/*
